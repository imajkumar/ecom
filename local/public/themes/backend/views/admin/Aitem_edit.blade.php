...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Product <small>edit</small></h1>
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a href="#addItem" data-toggle="tab" class="nav-link active">
                                    ...
                                    <span class="d-sm-block d-none">Product Edit</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-sm-8">
                                                    ...
                                                    <div class="form-group row m-b-15">
                                                        <label class="col-md-12 col-sm-4 col-form-label" for="name">Product Name <span class="required-star">* </span> :</label>
                                                    ...
                                                    <div class="form-group row m-b-15">
                                                        <label class="col-md-12 col-sm-4 col-form-label" for="name">Product Discription <span class="required-star">* </span> :</label>
                                                        <div class="col-md-12 col-sm-8">
                                                            <input class="form-control" type="text" id="name" name="item_name" value="{{$item->item_name}}" placeholder="Required" data-parsley-required="true">
                                                        </div>
                                                    </div>
