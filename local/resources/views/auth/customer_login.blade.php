...
<head>
	<meta charset="utf-8" />
	<title>{{ WEB_TITLE}} | Login Page</title>
		...
		<div class="login login-with-news-feed">
			...
			<div class="right-content">
				...
				<div class="login-header">
					<div class="brand">
						<span class="logo"><i class="ion-ios-cloud"></i></span> <b></b> Customer Login
						<small></small>
					</div>
					<div class="icon">
				...
				<div class="login-content">
                    ...
                    @csrf
						...
						<div class="login-buttons">
							<button type="submit" id="senOtpBtn" class="btn btn-success btn-block btn-lg">Send otp</button>
						</div>
